...
!(function () {
  ...
  (window.MaterialProgress = h),
    ...
    (h.prototype.CssClasses_ = { INDETERMINATE_CLASS: "mdl-progress__indeterminate" }),
  ...
  (window.MaterialSlider = p),
    ...
    (p.prototype.updateValueStyles_ = function () {
      ...
      0 === e ? this.element_.classList.add(this.CssClasses_.IS_LOWEST_VALUE) : this.element_.classList.remove(this.CssClasses_.IS_LOWEST_VALUE),
        this.isIE_ || ((this.backgroundLower_.style.flex = e), (this.backgroundLower_.style.webkitFlex = e), (this.backgroundUpper_.style.flex = 1 - e), (this.backgroundUpper_.style.webkitFlex = 1 - e));
    }),
        ...
        setTimeout(
          function () {
            this.element_.setAttribute("aria-hidden", "true"),
              ...
              Boolean(this.actionElement_.getAttribute("aria-hidden")) || (this.setActionHidden_(!0), (this.actionElement_.textContent = ""), this.actionElement_.removeEventListener("click", this.actionHandler_)),
  ...
  (window.MaterialTooltip = I),
    ...
    (I.prototype.handleMouseEnter_ = function (e) {
      ...
      this.element_.classList.contains(this.CssClasses_.LEFT) || this.element_.classList.contains(this.CssClasses_.RIGHT)
        ? ((s = t.width / 2), i + a < 0 ? ((this.element_.style.top = "0"), (this.element_.style.marginTop = "0")) : ((this.element_.style.top = i + "px"), (this.element_.style.marginTop = a + "px")))
        : s + n < 0
        ? ((this.element_.style.left = "0"), (this.element_.style.marginLeft = "0"))
        : ((this.element_.style.left = s + "px"), (this.element_.style.marginLeft = n + "px")),
        this.element_.classList.contains(this.CssClasses_.TOP)
          ? (this.element_.style.top = t.top - this.element_.offsetHeight - 10 + "px")
          ...
          ? (this.element_.style.left = t.left - this.element_.offsetWidth - 10 + "px")
  ...
  (window.MaterialDataTable = b),
    ...
    (b.prototype.CssClasses_ = { DATA_TABLE: "mdl-data-table", SELECTABLE: "mdl-data-table--selectable", SELECT_ELEMENT: "mdl-data-table__select", IS_SELECTED: "is-selected", IS_UPGRADED: "is-upgraded" }),
    ...
    (b.prototype.createCheckbox_ = function (e, t) {
      ...
      return (
        ...
        e ? ((a.checked = e.classList.contains(this.CssClasses_.IS_SELECTED)), a.addEventListener("change", this.selectRow_(a, e))) : t && a.addEventListener("change", this.selectRow_(a, null, t)),
        i.appendChild(a),
        ...
        this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT_IGNORE_EVENTS) ||
          ...
          (this.setRippleStyles = function (t) {
            if (null !== this.rippleElement_) {
              ...
              t
                ? ((i = this.Constant_.INITIAL_SCALE), (n = this.Constant_.INITIAL_SIZE))
                : ((i = this.Constant_.FINAL_SCALE), (n = this.rippleSize_ + "px"), e && (a = "translate(" + this.boundWidth / 2 + "px, " + this.boundHeight / 2 + "px)")),
